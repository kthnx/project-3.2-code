var title = "Punch Bowl",
  ...
  alcohollevel = "30% alcohol",
  nonalcohollevel = "70% non - alcohol",
...
function preload() {
  ...
  alert2 = loadImage("asset/punchbowl/alert2.png");
}
...
function draw() {
  ...
  image(alert2, (width/2)-50, 280, 115, 145);

  textSize(12);
  textFont(bold);
  fill(256);
  textWrap(WORD);
  text("Hey, your alcohol percentage is 30% ! It’s time for a small walk!!", 40, 470, 320);
