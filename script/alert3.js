var title = "Punch Bowl",
  ...
  alcohollevel = "80% alcohol",
  nonalcohollevel = "20% non - alcohol",
...
function preload() {
  ...
  alert3 = loadImage("asset/punchbowl/alert3.png");
  uber = loadImage("asset/punchbowl/uber.png");
}
...
function draw() {
  ...
  image(alert3, (width/2)-40, 280, 85, 150);

  textSize(12);
  textFont(bold);
  fill(256);
  textWrap(WORD);
  text("Hey, your alcohol percentage is 80% ! It’s not safe for you to drive anymore  Lets call an Uber !!", 35, 470, 320);
  ...
  fill("#15184B");
  textWrap(WORD);
  text("Book your Ride", (width/2)-60, 542, 320);

  image(uber, 276, 523, 54, 54);
